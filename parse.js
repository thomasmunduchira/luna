...
function organizeArray(phrase) {
  ...
  var shortestlink = linkarray.reduce(function(p, c) {
    return p.length > c.length ? c : p;
  }, {
    length: Infinity
  });
  var shortesttext = textarray.reduce(function(p, c) {
    return p.length > c.length ? c : p;
  }, {
    length: Infinity
  });
...
function getWebsite(phrase) {
  ...
  var topdefault = ["google.com", "facebook.com", "wikipedia.com", "youtube.com",
    "baidu.com", "live.com", "amazon.com", "qq.com", "twitter.com", "yahoo.com",
    ...
    "espn.go.com", "weather.com", "bankofamerica.com", "nytimes.com", "reddit.com",
    "msn.com", "foxnews.com", "nbcnews.com", "usatoday.com", "dailymail.co.uk",
    "wsj.com", "bbc.com", "nytimes.com", "latimes.com", "github.com"
  ];
